...
class UnitreeG1FixedBaseDataConfig(BaseDataConfig):
    """
    Data configuration for UnitreeG1 fixed-base manipulation (pick-and-place).

    No base height or navigation commands — robot is fixed to ground.
    Actions: arms + hands + waist (31D total from PINK IK).

    Usage:
        isaaclab_arena_gr00t.data_config:UnitreeG1FixedBaseDataConfig
    """
